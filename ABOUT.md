...
│   └── DeviceWarning.tsx # Apple/iOS compatibility warning
...
- **auth_attempts** - Security monitoring and rate limiting
...
- **flame_strength** - Connection strength tracking
...
- **Supabase Subscriptions** - Real-time database changes and messaging
- **Cross-tab Communication** - Seamless experience across browser tabs
...
- **Caching Strategy** - Intelligent caching of conversations and user data
