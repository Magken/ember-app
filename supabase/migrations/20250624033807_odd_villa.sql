/*
  ...
  1. New Tables
    - `user_profiles` - Extended user information with nickname, unique code, bio
    - `user_agreements` - Terms and conditions acceptance tracking
    - `auth_attempts` - Authentication attempt logging for rate limiting
  ...
  2. Security
    ...
    - Add functions for validation and rate limiting
...
-- Drop and recreate the log_auth_attempt function to avoid conflicts
