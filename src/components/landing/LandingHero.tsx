  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-8 py-16">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        {/* Individual Letter Burning Aesthetic Logo */}
        <div className="mb-12 relative overflow-visible">
          <div className="inline-flex items-center justify-center gap-3 relative overflow-visible">
            ...
            {/* Individual Letters with Burning Aesthetic */}
            {['e', 'm', 'b', 'r'].map((letter, index) => (
              ...
              >
                ...
                {/* Main letter with original gradient coloration */}
                <span 
        ...
        <div className="pt-8">
          <button
            ...
            className="px-8 py-4 bg-gradient-to-br from-ember to-carmine text-dark font-semibold rounded-soft hover:scale-105 transition-all duration-300 shadow-ember"
          >
            Start a spark
          </button>
        </div>
